Criar um banco de dados para receber os dados das planilhas  e fazer uma analise das tabelas Produtos e Nota Fiscal(Criatividade do Grupo). Fazer uma apresentação para a turma.  
